  ...
  return (
    <div className="flex w-full h-full">
      <div className="w-full h-full flex items-center justify-center flex-col gap-16 lg:w-1/2">
        <Logo className='h-6 text-gray-500 px-8' />
      ...
      <div className="w-1/2 h-full justify-center items-center p-8 relative hidden lg:flex">
        ...
        />
        <div className='max-w-[656px] bottom-8 mx-8 bg-white p-10 rounded-b-[32px] absolute'>
          <Logo className='text-teal-900 h-8' />
          <p className='mt-6 text-gray-700 font-medium text-xl'>
